...
# from itl.decorators import deprecated
...
class SlimNetsLayer(Layer):
    """A layer that merges TF-Slim models into itl.

    Models can be found in `slim-model <https://github.com/tensorflow/models/tree/master/research/slim#pre-trained-models>`__,
    see Inception V3 example on `Github <https://github.com/itl/itl/blob/master/example/tutorial_inceptionV3_tfslim.py>`__.
...
class KerasLayer(Layer):
    """A layer to import Keras layers into itl.

    Example can be found here `tutorial_keras.py <https://github.com/itl/itl/blob/master/example/tutorial_keras.py>`__.
...
class EstimatorLayer(Layer):
    ...
    It is similar with :class:`KerasLayer`, see `tutorial_keras.py <https://github.com/itl/itl/blob/master/example/tutorial_keras.py>`__.
