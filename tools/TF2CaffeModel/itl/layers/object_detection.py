...
try:
    roi_pooling = LazyImport("itl.third_party.roi_pooling.roi_pooling.roi_pooling_ops")
except Exception as e:
    logging.error(e)
    logging.error("HINT: 1. https://github.com/deepsense-ai/roi-pooling  2. itl/third_party/roi_pooling")
...
class ROIPoolingLayer(Layer):
    ...
    - Please install it by the instruction `HERE <https://github.com/itl/itl/blob/master/itl/third_party/roi_pooling/README.md>`__.
