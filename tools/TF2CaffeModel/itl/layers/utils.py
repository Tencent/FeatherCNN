...
# @deprecated(date="2018-06-30", instructions="itl relies on TensorFlow to check naming")
...
def merge_networks(layers=None):
    ...
    """
    if layers is None:
        raise Exception("layers should be a list of itl's Layers.")
    layer = layers[0]
...
# @deprecated(date="2018-06-30", instructions="itl relies on TensorFlow to check name reusing")
