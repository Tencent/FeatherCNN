...
class RNNLayer(Layer):
    ...
    Examples
    --------
    - For synced sequence input and output, see `PTB example <https://github.com/itl/itl/blob/master/example/tutorial_ptb_lstm_state_is_tuple.py>`__
    ...
    - see TensorFlow tutorial ``ptb_word_lm.py``, itl tutorials ``tutorial_ptb_lstm*.py`` and ``tutorial_generate_text.py``
...
class Seq2Seq(Layer):
    ...
    - Please check this example `Chatbot in 200 lines of code <https://github.com/itl/seq2seq-chatbot>`__.
