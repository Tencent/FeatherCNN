...
from itl.layers.utils import flatten_reshape
...
class FlattenLayer(Layer):
    ...
    def to_caffe_prototxt(self, recursive=True):
        flatten_layer = self.create_caffe_layer()
        flatten_layer.name = self.name
        flatten_layer.type = 'Flatten'
        self.append_bottom_from_inputs(flatten_layer)
        self.append_top_from_outputs(flatten_layer)
...
if __name__ == '__main__':
    ...
    net.dump_all_layers_to_caffe_prototxt()
    print(str(net.get_caffe_model()))
