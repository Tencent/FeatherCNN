...
from itl.layers import DenseLayer
...
class VGG19Base(object):
    ...
    def restore_params(self, sess):
        ...
        maybe_download_and_extract(
            'vgg19.npy', 'models',
            'https://media.githubusercontent.com/media/itl/pretrained-models/master/models/',
...
class VGG19(VGG19Base):
    ...
    Examples
    ---------
    Classify ImageNet classes with VGG19, see `tutorial_models_vgg19.py <https://github.com/itl/itl/blob/master/example/tutorial_models_vgg19.py>`__
