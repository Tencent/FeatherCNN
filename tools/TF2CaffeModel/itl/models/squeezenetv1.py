...
from itl.layers import Layer
from itl.layers import Conv2d
from itl.layers import InputLayer
from itl.layers import MaxPool2d
from itl.layers import ConcatLayer
from itl.layers import DropoutLayer
from itl.layers import GlobalMeanPool2d

from itl.files import maybe_download_and_extract
from itl.files import assign_params
from itl.files import load_npz
...
class SqueezeNetV1(Layer):
    ...
    Examples
    ---------
    Classify ImageNet classes, see `tutorial_models_squeezenetv1.py <https://github.com/itl/itl/blob/master/example/tutorial_models_squeezenetv1.py>`__
    ...
    def restore_params(self, sess, path='models'):
        ...
        maybe_download_and_extract(
            'squeezenet.npz', path, 'https://github.com/itl/pretrained-models/raw/master/models/',
