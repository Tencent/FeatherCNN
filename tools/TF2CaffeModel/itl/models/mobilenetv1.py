...
from itl.layers import BatchNormLayer
from itl.layers import Conv2d
from itl.layers import DepthwiseConv2d
from itl.layers import FlattenLayer
from itl.layers import GlobalMeanPool2d
from itl.layers import InputLayer
from itl.layers import ReshapeLayer

from itl.files import maybe_download_and_extract, assign_params, load_npz
...
class MobileNetV1(Layer):
    ...
    Examples
    ---------
    Classify ImageNet classes, see `tutorial_models_mobilenetv1.py <https://github.com/itl/itl/blob/master/example/tutorial_models_mobilenetv1.py>`__
    ...
    def restore_params(self, sess, path='models'):
        ...
        maybe_download_and_extract(
            'mobilenet.npz', path, 'https://github.com/itl/pretrained-models/raw/master/models/',
