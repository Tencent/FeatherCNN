...
class Trainer(object):
    ...
    itl Trainer is a high-level training interface built on top of TensorFlow MonitoredSession and
    `Horovod <https://github.com/uber/horovod>`__. It transparently scales the training of a itl model
    ...
    `itl/scripts/download_and_install_openmpi3_ubuntu.sh`
    ...
    Attributes
    ----------
    training_network : class itl ``Layer``
        The training model.
    ...
    <https://github.com/itl/itl/blob/master/example/tutorial_mnist_distributed_trainer.py>`__.
...
# @deprecated(date="2018-10-30", instructions="Using the itl distributed trainer.")
