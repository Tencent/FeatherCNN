...
def fit(
    ...
    - MNIST example click `here <https://github.com/itl/itl/blob/master/example/tutorial_mnist_simple.py>`_.
    - In order to control the training details, the authors HIGHLY recommend ``tl.iterate`` see two MNIST examples `1 <https://github.com/itl/itl/blob/master/example/tutorial_mlp_dropout1.py>`_, `2 <https://github.com/itl/itl/blob/master/example/tutorial_mlp_dropout1.py>`_.
    ...
    Examples
    --------
    See `tutorial_mnist_simple.py <https://github.com/itl/itl/blob/master/example/tutorial_mnist_simple.py>`_
