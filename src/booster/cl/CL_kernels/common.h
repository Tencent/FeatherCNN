...
#define CMD_SUFFIX_STR(cmd, suffix) cmd##suffix
#define CMD_TYPE(cmd, type) CMD_SUFFIX_STR(cmd, type)
#define CMD_SIZE(cmd, size) CMD_SUFFIX_STR(cmd, size)

#define DATA_TYPE4 VEC_DATA_TYPE(DATA_TYPE, 4)
#define DATA_TYPEK VEC_DATA_TYPE(DATA_TYPE, CHANNEL_GROUP_SIZE)
...
#define READ_VECTOR(offset, p) \
  CMD_SIZE(vload, CHANNEL_GROUP_SIZE)(offset, p)
#define WRITE_VECTOR(data, offset, p) \
  CMD_SIZE(vload, CHANNEL_GROUP_SIZE)(data, offset, p)
